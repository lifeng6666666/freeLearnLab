...
目录：[principles](principles/)

这是一份把已被科学和人类实践验证的有效经验，凝练为可执行清单的知识手册。全书整理 54 条原则，覆盖健康、学习、工作、思考、情绪、关系、习惯七个领域，每条按「原则陈述 → 为什么 → 实例 → 行动指导 → 如何量化 → 实践练习」六段式展开，不仅讲清"是什么"，更落到"怎么做到"。

课程特点：**证据为本**（每条原则均有科学研究或大规模实践支撑）、**六段式展开**（从原理到练习的完整闭环）、**重实践**（第 8 章实践工作坊提供 30 天实验模板、原则实验日志、原则审计表等五个工具，把「读到」转化为「做到」）。

#### 章节一览

| 章节 | 主题 | 条数 |
| --- | --- | --- |
| 第一章 | 健康与精力 | 睡眠、运动、饮食、节律等 8 条 |
| 第二章 | 学习方法 | 主动回忆、间隔重复、费曼学习法等 8 条 |
| 第三章 | 工作与职业 | 选择、杠杆、输出、复利等 8 条 |
| 第四章 | 思考与表达 | 第一性原理、金字塔原理、概率思维等 8 条 |
| 第五章 | 情绪与激情 | 情绪命名、心流条件、成长型思维等 7 条 |
| 第六章 | 关系与人际 | 主动倾听、非暴力沟通、弱关系力量等 7 条 |
| 第七章 | 习惯与自律 | 习惯回路、两分钟法则、系统优于目标等 8 条 |
| 第八章 | 实践工作坊 | 30 天实验模板、原则审计表等 5 个工具 |

课程资料包括：

- [原则：生活学习工作思考的基本原则（PDF）](principles/原则-生活学习工作思考的基本原则.pdf)：54 条原则的完整展开、证据说明与配套练习工具。
